            ...
            <Row className="mt-5 justify-content-md-center">
                <Col md={6}>
                    ...
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <Alert show={registerUserResponseState && registerUserResponseState.error === "user exists"}
                               variant="danger">
                            User with that email already exists!
                        </Alert>
                        <Alert show={registerUserResponseState && registerUserResponseState.success === "User created"}
                               variant="info">
                            User created
                        </Alert>
                    </Form>
